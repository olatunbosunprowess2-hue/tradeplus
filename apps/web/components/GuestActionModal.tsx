        ...
        >
            ...
            >
                ...
                <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-6 py-8 text-center relative overflow-hidden">
                    {/* Decorative circles */}
                    <div className="absolute top-2 left-4 w-20 h-20 bg-white/10 rounded-full blur-xl" />
                    <div className="absolute bottom-0 right-4 w-16 h-16 bg-white/10 rounded-full blur-lg" />
