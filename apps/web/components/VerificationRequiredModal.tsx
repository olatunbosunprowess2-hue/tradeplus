...
export default function VerificationRequiredModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
                {/* Icon */}
                ...
                {!isPending && (
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 mb-4">
                        <p className="text-xs font-semibold text-blue-900 mb-1">Why is this mandatory?</p>
                ...
                {isPending && (
                    <div className="bg-green-50 border border-green-200 rounded-xl p-3 mb-4 text-center">
                        <p className="text-xs font-semibold text-green-900 mb-1">⏱️ Expected Review Time</p>
                        <p className="text-xs text-green-800">Your account will be reviewed within <strong>24-48 hours</strong></p>
                    </div>
                )}
                ...
                {!isPending ? (
                    <div className="space-y-3">
                        <button
                            ...
                            className="w-full bg-blue-50 border border-blue-200 text-blue-900 p-3 rounded-xl flex items-center justify-between hover:bg-blue-100 transition group text-left"
                        >
                            <div>
                                <div className="font-bold text-base">Verify Identity</div>
                                <div className="text-blue-700 text-xs">For individuals & small businesses</div>
                            </div>
                        ...
                        <button
                            ...
                            className="w-full bg-amber-50 border border-amber-200 text-amber-900 p-3 rounded-xl flex items-center justify-between hover:bg-amber-100 transition group text-left"
                        >
                            <div>
                                ...
                                <div className="text-amber-700 text-xs">For established brands & verified sellers</div>
                            </div>
                        ...
                        <button
                            onClick={onClose}
                            className="w-full text-gray-400 text-xs hover:text-gray-600 font-medium py-2"
                        >
                            Maybe Later
                        </button>
                    </div>
                    ...
                    <button
                        onClick={onClose}
                        className="w-full bg-gray-100 text-gray-700 text-center py-3 rounded-xl font-bold text-base hover:bg-gray-200 transition"
                    >
                        I Understand & Cancel
                    </button>
                )}
