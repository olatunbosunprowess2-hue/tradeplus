    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-md w-full relative z-10">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-blue-500/10 p-8 border border-white/50 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
                        ...
                        >
                            {loading ? (
                                <span className="flex items-center gap-1.5 py-1 justify-center">
                                    <span className="w-2 h-2 bg-white rounded-full animate-dot-1" />
                                    <span className="w-2 h-2 bg-white rounded-full animate-dot-2" />
                                    <span className="w-2 h-2 bg-white rounded-full animate-dot-3" />
                                </span>
                            ) : (
                                buttonText
                            )}
                    ...
                    <div className="mt-6">
                        ...
                        >
                            {googleLoading ? (
                                <span className="flex items-center gap-1.5 py-1 justify-center">
                                    <span className="w-2 h-2 bg-gray-500 rounded-full animate-dot-1" />
                                    <span className="w-2 h-2 bg-gray-500 rounded-full animate-dot-2" />
                                    <span className="w-2 h-2 bg-gray-500 rounded-full animate-dot-3" />
                                </span>
                            ) : (
                                <>
